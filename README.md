...
┌─────────────────────┬──────────────┬─────────────────┬───────────────────┬─────────────┐
│ Industry Group      │ COVID Period │ Employment Rate │ Unemployment Rate │ % Full-time │
├─────────────────────┼──────────────┼─────────────────┼───────────────────┼─────────────┤
│ Retail Trade        │ Pre-COVID    │ 94.3%          │ 5.7%             │ 56.1%       │
│ Retail Trade        │ COVID Peak   │ 86.1%          │ 13.9%            │ 49.1%       │
│ Retail Trade        │ Recovery     │ 93.0%          │ 7.0%             │ 56.1%       │
│ Professional Svcs   │ Pre-COVID    │ 97.6%          │ 2.4%             │ 70.4%       │
│ Professional Svcs   │ COVID Peak   │ 93.4%          │ 6.6%             │ 64.2%       │
│ Professional Svcs   │ Recovery     │ 96.9%          │ 3.1%             │ 70.6%       │
│ Manufacturing       │ Pre-COVID    │ 96.2%          │ 3.8%             │ 84.2%       │
│ Manufacturing       │ COVID Peak   │ 92.3%          │ 7.7%             │ 76.7%       │
│ Manufacturing       │ Recovery     │ 96.0%          │ 4.1%             │ 83.1%       │
│ Construction        │ Pre-COVID    │ 94.2%          │ 5.8%             │ 73.0%       │
│ Construction        │ COVID Peak   │ 90.9%          │ 9.1%             │ 68.5%       │
│ Construction        │ Recovery     │ 93.7%          │ 6.3%             │ 74.7%       │
└─────────────────────┴──────────────┴─────────────────┴───────────────────┴─────────────┘

Retail vs Non-Retail Comparison:
┌─────────────┬─────────────┬─────────────────┬───────────────────┬─────────────────────┐
│ Industry    │ Period      │ Employment Rate │ Unemployment Rate │ COVID Impact Rate   │
├─────────────┼─────────────┼─────────────────┼───────────────────┼─────────────────────┤
│ Non-Retail  │ Pre-COVID   │ 96.2%          │ 3.9%             │ N/A                 │
│ Non-Retail  │ Post-COVID  │ 94.0%          │ 6.0%             │ 24.5%               │
│ Retail      │ Pre-COVID   │ 94.3%          │ 5.7%             │ N/A                 │
│ Retail      │ Post-COVID  │ 90.6%          │ 9.4%             │ 13.2%               │
└─────────────┴─────────────┴─────────────────┴───────────────────┴─────────────────────┘
